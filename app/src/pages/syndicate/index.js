...
const Syndicate = (props) => {
	...
	const TitleHeader = () => {
		const useTitle = useMediaQuery('(min-width:1500px)') ? 'Syndicate Cheat Sheet 3.20' : 'Syndicate Cheat Sheet';
		...
		<div className={`syndicate page ${display}`}>
			...
			<div className={toggleDiv}>
				...
				<Card variant="infoVariant">
					{/* <div className="info"> */}
					<p>The above table is a customizable Syndicate Cheat Sheet for the Betrayal league mechanic in POE 3.20. When in individual mode, it shows the possible rewards for running a Syndicate safehouse (Transportation, Fortification, Research and Intervention) with a given member in that safehouse.</p>
